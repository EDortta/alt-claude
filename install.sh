...
install -m 0755 "$ROOT/tools/usage-report.py" "$TARGET_DIR/alt-claude-usage"
...
printf 'Quota/saúde: alt-claude --usage\n'
printf 'Ajuda de chaves: alt-claude help keys\n'
